...
public class TC_AccountSettingsVerifyNewPasswordFieldValidationDev extends TestUtil {
	...
	FileUtils.copyFile(scrFile, new File("c:\\tmp\\TC_AccountSettingsVerifyNewPasswordFieldValidationDev.png"));
