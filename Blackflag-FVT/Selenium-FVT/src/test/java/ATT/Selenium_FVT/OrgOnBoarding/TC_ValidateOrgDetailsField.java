...
public class TC_ValidateOrgDetailsField extends TestUtil{
	...
	public void validateOrgDetailsFields_test() {
		...
		organizationDetailsPage.field_Enabled();
		
		//method to validate fields are prepopulated on Org Details Page
		organizationDetailsPage.field_Prepopulated();
		
		//method to publish Test Reuslt
	...
	FileUtils.copyFile(scrFile, new File("c:\\tmp\\TC_ValidateOrgDetailsField.png"));
